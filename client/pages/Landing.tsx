...
import Navbar from "@/components/layout/Navbar"; // This will now show the user profile
...
export default function Landing() {
  ...
  useEffect(() => {
    // This logic remains the same: it handles the login redirect
  ...
  return (
    <div className="relative min-h-screen bg-[radial-gradient(ellipse_at_top_left,theme(colors.slate.950),theme(colors.slate.900))]">
      ...
      <Noise />
      <LockBadge />
      <Navbar /> {/* The updated Navbar is used here */}
      <main className="mx-auto w-full max-w-[1440px] px-8 pb-24 pt-10">
        <section className="mx-auto grid max-w-7xl grid-cols-1 gap-6 md:grid-cols-3">
          ...
          <Card className="md:col-span-2 border-white/10 bg-white/5 backdrop-blur">
            <CardHeader>
              ...
              <CardDescription>
                Name your analysis and get started
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                You can upload PDF, DOCX, TXT, CSV, JSON and images in the
                analysis page.
              </p>
            </CardContent>
          </Card>
